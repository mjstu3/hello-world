...
public class StormActor extends SWActor {
	 ...
	 */
	public StormActor(MessageRenderer m, SWWorld world, int trainingpoints, int forceAbility) {
		super(Team.EVIL, 50, m, world, trainingpoints, forceAbility);
	}
