...
public class TuskenRaider extends SWActor {
	 ...
	 * 
	 */
	public TuskenRaider(int hitpoints, String name, MessageRenderer m, SWWorld world, int trainingpoints, int forceAbility) {
		super(Team.TUSKEN, hitpoints, m, world, trainingpoints, forceAbility);
