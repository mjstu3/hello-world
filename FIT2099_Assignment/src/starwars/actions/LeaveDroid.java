...
public class LeaveDroid extends SWAffordance {

	public LeaveDroid(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);
	}
	...
	public boolean canDo(SWActor a) {
		return a.getDroidCarried().equals(target);
	}
	...
	public void act(SWActor a) {
		if (a.getDroidCarried() == null) { // the actor is not holding something
			...
			if (target instanceof SWEntityInterface) {
				...
				target.addAffordance(new TakeDroid((SWEntityInterface)target, this.messageRenderer)); // add a Take affordance
			}
		}
	}
