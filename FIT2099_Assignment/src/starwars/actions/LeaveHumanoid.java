...
public class LeaveHumanoid extends SWAffordance {

	public LeaveHumanoid(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);
	}
	...
	public boolean canDo(SWActor a) {
		return a.getCharaCarried().equals(target);
	}
	...
	public void act(SWActor a) {
		if (a.getCharaCarried() == null) { // the actor is not holding something
			...
			if (target instanceof SWEntityInterface) {
				...
				a.setCharaCarried(null);
				target.removeAffordance(this);
				target.addAffordance(new TakeHumanoid((SWEntityInterface)target, this.messageRenderer)); // add a Take affordance
			}
		}
	}
	...
	public String getDescription() {
		return "Leave behind " + target.getShortDescription();
	}
