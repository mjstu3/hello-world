 ...
 */
public class TakeHumanoid extends SWAffordance {
	 ...
	 */
	public TakeHumanoid(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);
		priority = 1;
	...
	public void act(SWActor a) {
		if (target instanceof SWEntityInterface) {
			...
			target.addAffordance(new LeaveHumanoid(theItem, messageRenderer));
	...
	public String getDescription() {
		return target.getShortDescription() + " is following you!";
	}
