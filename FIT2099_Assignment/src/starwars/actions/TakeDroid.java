 ...
 */
public class TakeDroid extends SWAffordance {
	 ...
	 */
	public TakeDroid(SWEntityInterface theTarget, MessageRenderer m) {
		super(theTarget, m);
		priority = 1;
	}
	...
	public void act(SWActor a) {
		if (target instanceof SWEntityInterface) {
			...
			target.addAffordance(new LeaveDroid(theItem, messageRenderer));
