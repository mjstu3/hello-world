...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	/**The level of <code>forceAbility</code> of this actor. The forceAbility ranges from 0-100*/
	 ...
	 * @see 	#forceAbility
	 */
	public SWActor(Team team, int hitpoints, MessageRenderer m, SWWorld world, int trainingpoints, int forceAbility) {
		super(m);
	 ...
	 * 
	 * @return the amount of forceAbility
	 */
	@Override
